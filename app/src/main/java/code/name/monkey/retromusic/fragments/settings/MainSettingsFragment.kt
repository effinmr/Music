...
class MainSettingsFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        allSearchableSettings = listOf(
            ...
            SearchableSetting(R.id.personalizeSettings, getString(R.string.pref_title_disabled_now_playing_taps), getString(R.string.pref_summary_disabled_now_playing_taps), false, R.id.action_mainSettingsFragment_to_personalizeSettingsFragment),
            ...
            SearchableSetting(R.id.otherSettings, getString(R.string.pref_title_online_mode), getString(R.string.pref_summary_online_mode), false, R.id.action_mainSettingsFragment_to_otherSettingsFragment),
