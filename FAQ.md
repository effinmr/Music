...
There are three methods for adding offline synced lyrics in Music.
...
### STEP 4: 
Now use any file manager to paste the LRC files to the path where your song is located.
...
- The music in-built equalizer was removed updates ago so the only equalizer you will have by your OEM or Android native equalizer which isn't made by us and have no control over them. So you can report those issues to your OEM so that they can provide a fix in the next updates.
...
1. Then open the Music app and manually scan your music from your storage. 
...
- Music's font has now been replaced with system font, which means the default font your system uses will be used by Music too. It fixes all font-related issues you used to face/are facing in the app. 

- With the recent Music v5 release, we have a built-in optional font "Manrope font" which you can toggle from Settings > Look & Feel > Toggle "Use manrope font".
...
In your built-in music player, there should be an option to save that playlist as a file. Save them and import them from the file manager by opening it into Music.
